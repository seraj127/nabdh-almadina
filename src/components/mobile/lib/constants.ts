...
export const LOCAL_CATEGORIES: Category[] = [
  ...
  { id: 'cmocboa8c0002mtchjyp2zx9e', nameAr: 'أدوات التقديم', nameEn: 'Serving Ware', slug: 'serving-ware', icon: '🥣', image: '/categories/serving-ware.png', productCount: 7 },
...
export const LOCAL_SUBCATEGORIES: Subcategory[] = [
  ...
  { id: 'sub-plates-dishes', nameAr: 'صحون وأطباق', nameEn: 'Plates & Dishes', slug: 'plates-dishes', icon: '🥣', productCount: 0, parentId: 'serving-ware' },
