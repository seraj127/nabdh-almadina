...
export const DEMO_NOTIFICATIONS: AppNotification[] = [
  {
    id: 'notif-1',
    title: 'Êã ÊÃßíÏ ØáÈß',
    body: 'ØáÈß ÑÞã #NB-2024-0891 Êã ÊÃßíÏå ÈäÌÇÍ æÓíÊã ÔÍäå ÞÑíÈÇð',
    type: 'order',
    isRead: false,
  ...
  },
  {
    id: 'notif-2',
    title: 'ÚÑÖ ÎÇÕ ??',
    body: 'ÎÕã 25% Úáì ÌãíÚ ãäÊÌÇÊ ÇáãØÈÎ! ÇáÚÑÖ íäÊåí ÎáÇá 48 ÓÇÚÉ',
    type: 'promo',
    isRead: false,
  ...
  {
    id: 'notif-3',
    title: 'ÇÓÊÑÏÇÏ äÞÇØ ãßÇÝÃÉ',
    body: 'Êã ÅÖÇÝÉ 50 äÞØÉ æáÇÁ Åáì ÑÕíÏß ß ãßÇÝÃÉ Úáì ØáÈß ÇáÃÎíÑ',
    type: 'wallet',
    isRead: true,
  ...
  },
  {
    id: 'notif-4',
    title: 'ÊÍÏíË ÇáÊØÈíÞ',
    body: 'Êã ÊÍÏíË äÈÖ ÇáãÏíäÉ Åáì ÇáÅÕÏÇÑ 1.1.0 ãÚ ãíÒÇÊ ÌÏíÏÉ æÊÍÓíäÇÊ Ýí ÇáÃÏÇÁ',
    type: 'system',
    isRead: true,
  ...
  },
  {
    id: 'notif-5',
    title: 'Êã ÔÍä ØáÈß',
    body: 'ØáÈß ÑÞã #NB-2024-0876 Ýí ÇáØÑíÞ Åáíß! ÇáÊæÕíá ÇáãÊæÞÚ ÎáÇá 24 ÓÇÚÉ',
    type: 'order',
    isRead: false,
